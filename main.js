...
(function () {
  ...
  // ── Card Issuing & Programme Management page (ci_) ──────────────────────
  ...
  ci_p_design1:'برنامج البطاقة ليس مجرد فئة منتج: إنه مجموعة متشابكة من القرارات التجارية والتقنية والتنظيمية التي تحدد اقتصاديات البرنامج وملف مخاطره والقيمة المقدمة للعملاء.',
  ci_p_design2:'كل قرار من هذه القرارات يتفاعل مع الآخرين بطرق لا تكون دائماً واضحة حتى مرحلة التنفيذ. الحصول على بنية البرنامج الصحيحة في مرحلة التصميم يمنع إعادة الهيكلة المكلفة.',
  ci_p_design3:'نعمل مع البنوك وشركات الفينتك والجهات المصدرة غير البنكية في مرحلة التصميم لتحديد بنية المنتج ونمذجة اقتصاديات الوحدة وإعداد مواصفات المتطلبات.',
  ci_li_design_1:'بنية البرنامج: تحديد نوع البطاقة والشبكة وشريحة العملاء والنموذج التجاري',
  ci_li_design_2:'نمذجة اقتصاديات الوحدة: دخل العمولة وتكاليف المعالج وخسائر الاحتيال والتزام المكافآت وهامش المساهمة',
  ci_li_design_3:'التصنيف التنظيمي: الترخيص المصرفي مقابل ترخيص النقود الإلكترونية مقابل رعاية BIN وانعكاسات كل منها',
  ci_li_design_4:'استراتيجية الطرح في السوق: نموذج التوزيع والقنوات الشريكة ونمذجة تكلفة اكتساب العملاء',
  ci_h2_processor:'اختيار معالج البطاقات',
  ci_p_processor1:'شهد سوق معالجة البطاقات تحولاً جوهرياً منذ الحقبة التي كانت فيها البنوك تقتصر على خيارات المعالجين التقليديين الكبار.',
  ci_p_processor2:'يُعدّ اختيار المعالج لبرنامج البطاقة من أكثر القرارات التقنية أهميةً وأثراً. ترحيل برنامج قيد التشغيل بين معالجين عملية مكلفة ومحفوفة بمخاطر تشغيلية.',
  ci_p_processor3:'تشمل مشاركاتنا: مواصفات المتطلبات وتصميم طلب تقديم العروض ومقابلات المرجع ودعم التفاوض التجاري ومراجعة الاستعداد للتنفيذ.',
  ci_h4_apifirst:'منصات الفينتك وواجهة برمجة التطبيقات الأولى',
  ci_p_apifirst:'Marqeta وi2c وThredd وPomelo: مصممة لقابلية التخصيص العالية والتمويل المدمج وإطلاق البرامج السريع.',
  ci_h4_tier1:'معالجو الدرجة الأولى الكبار',
  ci_p_tier1:'TSYS وFIS وFiserv: وظائف متعمقة للمنتجات المصرفية المعقدة واتصال ناضج بالمخططات وسجل تشغيلي مثبت.',
  ci_h4_regional:'معالجو الخليج الإقليميون',
  ci_p_regional:'Network International وMagnati (الإمارات) والمعالجون المرتبطون بـ مدى (السعودية): أساسيون للمشاركة في المخططات المحلية.',
  ci_h4_embedded:'البنية التحتية للإصدار المدمج',
  ci_p_embedded:'Stripe Issuing وAdyen Issuing وRailsr: مصممة لمنصات SaaS والأسواق التي تدمج إصدار البطاقات في سير عمل المنتج.',
  ci_li_proc_1:'مواصفات المتطلبات عبر وظائف المعالجة ودعم المخطط والتغطية الإقليمية وجودة واجهة برمجة التطبيقات',
  ci_li_proc_2:'تصميم طلب تقديم العروض وإطار تقييم التسجيل المعياري حسب أولويات البرنامج',
  ci_li_proc_3:'فحوصات مرجعية مستقلة مع تطبيقات مقارنة لبرنامج العميل',
  ci_li_proc_4:'التفاوض على الشروط التجارية: رسوم المعالجة وتكاليف كل تفويض والتزامات الحجم الأدنى',
  ci_li_proc_5:'تخطيط الانتقال للبرامج المنتقلة من معالج قائم',
  ci_h2_bin:'رعاية BIN والعضوية في المخططات',
  ci_p_bin1:'يستلزم إصدار بطاقة فيزا أو ماستركارد الوصول إلى BIN (رقم تعريف البنك). ثمة مساران: رعاية BIN أو العضوية المباشرة في المخطط.',
  ci_p_bin2:'رعاية BIN أسرع إطلاقاً ولا تستلزم علاقة مباشرة مع المخطط. العضوية المباشرة توفر تحكماً أكبر وتزيل الاعتماد التجاري على الراعي.',
  ci_li_bin_1:'هيكل رعاية BIN: اختيار البنك الراعي والشروط التعاقدية وتوزيع المسؤولية والاقتصاديات التجارية',
  ci_li_bin_2:'تقييم العضوية في المخطط: أساسية مقابل منتسبة ومتطلبات رأس المال والاعتماد التقني',
  ci_li_bin_3:'المشاركة في المخططات المحلية: مدى (السعودية) وBENEFIT (البحرين) وميزة (مصر) وجيوان (قطر)',
  ci_li_bin_4:'اختيار برنامج منتج المخطط: Visa Commercial Solutions وMastercard Business Card وأهلية برنامج المكافآت',
  ci_h2_commercial:'برامج بطاقات الشركات',
  ci_p_commercial1:'تعمل برامج بطاقات الشركات بمنطق تجاري مختلف عن برامج المستهلكين. معدلات العمولة أعلى في الغالب في الأسواق غير المقيدة بسقف للعمولة.',
  ci_p_commercial2:'تتمحور القيمة المضافة لبطاقات الشركات حول رؤية الإنفاق وضوابط السياسات واقتصاديات البرنامج.',
  ci_h3_virtual:'برامج البطاقات الافتراضية',
  ci_p_virtual1:'أصبح إصدار البطاقات الافتراضية قدرةً أساسيةً لبرامج مدفوعات الشركات وشركات إدارة السفر ومنصات التمويل المدمج.',
  ci_p_virtual2:'بالنسبة للشركات الخليجية وشركات الفينتك التي تبني برامج بطاقات افتراضية، يعدّ اختيار المعالج أمراً بالغ الأهمية.',
  ci_li_comm_1:'تصميم برنامج بطاقات الشركات: الهيكل الائتماني وضوابط الإنفاق والتكامل مع أنظمة تخطيط موارد المؤسسات',
  ci_li_comm_2:'تقديم بيانات المستوى الثاني والثالث: متطلبات التأهل والتنفيذ التقني ونمذجة وفورات العمولة',
  ci_li_comm_3:'بنية برنامج البطاقة الافتراضية: لمرة واحدة مقابل متعددة الاستخدام والضوابط لكل معاملة',
  ci_li_comm_4:'تصميم برنامج الاسترداد: هياكل عتبة الإنفاق والمعجّلات القائمة على الفئات وآليات الدفع',
  ci_li_comm_5:'استراتيجية برنامج السفر والترفيه: تكامل بطاقة الإيداع وشراكات شركات إدارة السفر',
  ci_h2_portfolio:'إدارة المحافظ وتحسين العمولة',
  ci_p_portfolio1:'محفظة البطاقات المصممة بشكل صحيح ستؤدي أداءً دون إمكاناتها إذا لم تتطور ممارسات الإدارة. يُعدّ تحسين العمولة من أكثر روافع الإيرادات استغلالاً منخفضاً.',
  ci_p_portfolio2:'إدارة معدل الاحتيال وتخصيص الاحتياطيات وتحسين معدل الموافقة هي الروافع الرئيسية الثلاثة الأخرى.',
  ci_li_port_1:'تدقيق تأهل العمولة: تحديد الثغرات في تقديم البيانات التي تؤدي إلى التخفيض إلى فئات تبادل أعلى تكلفة',
  ci_li_port_2:'تحسين استراتيجية التفويض: تحسين معدل الموافقة دون زيادة التعرض للاحتيال',
  ci_li_port_3:'مراجعة نموذج الاحتيال: معايرة مراقبة المعاملات وتقسيم المخاطر وتحليل معدل النزاعات',
  ci_li_port_4:'تحليل ربحية المحفظة: تحليل الإيرادات والتكاليف حسب نوع البطاقة والقناة وشريحة العملاء',
  ci_li_port_5:'إدارة دورة حياة حاملي البطاقات: تحسين معدل التفعيل وتحفيز الإنفاق المبكر وخفض الإلغاء',
  ci_h3_cta:'ناقش متطلبات برنامج بطاقتك',
  ci_p_cta:'MENA Advisory تعمل مع البنوك وشركات الفينتك والجهات المصدرة غير البنكية في تصميم وإطلاق وتحسين برامج البطاقات. تحدث مباشرةً مع متخصص.',
  // ── FX & Treasury Payments page (fx_) ───────────────────────────────
  fx_h1:'مدفوعات العملات الأجنبية والخزينة',
  fx_cta_discuss:'ناقش هذا الحل →',
  fx_cta_all_sol:'جميع الحلول',
  fx_h2_gcc:'سياق المدفوعات العابرة للحدود في دول الخليج',
  fx_p_gcc1:'تُعدّ تدفقات المدفوعات العابرة للحدود في دول مجلس التعاون الخليجي من بين الأكبر عالميًا بالنسبة للناتج المحلي الإجمالي. تُبسّط اقتصادات المنطقة المرتبطة بالدولار بعض جوانب إدارة العملات الأجنبية للتدفقات الداخلية، غير أنها تخلق اعتمادًا محددًا على نظام المراسلة البنكية بالدولار.',
  fx_p_gcc2:'يواجه أمناء خزينة الشركات تحديات عملية تشمل: تأخيرات وغموض سلسلة المراسلة، وتكاليف تحويل العملات المضمّنة في رسوم التحويل، وتعقيدات فحص العقوبات وقيود التحويل ومستطلبات التوثيق.',
  fx_p_gcc3:'تواجه مؤسسات الدفع وشركات التكنولوجيا المالية تحديات مماثلة مضاعفة: صعوبة الحصول على وصول مصرفي مراسل، وضرورة الإدارة المتزامنة للالتزامات التنظيمية في طرفي الممر، والضغط المستمر على اقتصاديات المدفوعات من المنافسين الرقميين.',
  fx_stat_remit:'التحويلات الصادرة السنوية من دول الخليج',
  fx_stat_trade:'تدفقات تمويل التجارة السنوية في دول الخليج',
  fx_stat_curr:'عملات دول الخليج: مرتبطة بالدولار الأمريكي',
  fx_h2_swift:'خدمة SWIFT GPI وهجرة معيار ISO 20022',
  fx_p_swift1:'أصبحت خدمة الابتكار العالمي للمدفوعات (GPI) من SWIFT المعيارَ لمدفوعات المراسلة البنكية العابرة للحدود. توفر GPI تتبعًا شاملاً لحالة الدفعات من الطرف إلى الطرف، وتأكيدًا لقيد المبلغ في حساب المستفيد، وشفافية الرسوم المخصومة عند كل محطة مراسلة.',
  fx_h3_iso:'ISO 20022: الوضع الراهن والالتزامات',
  fx_p_iso1:'انتهت فترة التعايش بين معياري ISO 20022 لشبكة SWIFT في نوفمبر 2025. أصبحت رسائل MX وفق ISO 20022 الصيغةَ المطلوبة لتعليمات الدفع العابرة للحدود. المؤسسات غير المستوفية تعالج معاملاتها عبر طبقة ترجمة تحافظ على الوظائف التشغيلية لكنها تجرّد حقول البيانات المنظمة التي تجعل مدفوعات ISO 20022 قابلةً للقراءة آليًا وكفؤةً في فحص العقوبات.',
  fx_p_iso2:'الفجوة العملية التي تُحدثها هجرة ISO 20022 للمؤسسات غير المستوفية: تفقد المدفوعات الصادرة من طرف مستوفٍ لمعيار MX بياناتها المنظمة عند نقطة الترجمة. يُشغّل فحص عقوبات المؤسسة المُستلِمة على بيانات غير منظمة، مما يُفضي إلى معدلات إيجابية كاذبة أعلى ومعالجة أبطأ وتكاليف تشغيلية أكبر.',
  fx_li_iso_1:'تقييم الجاهزية لهجرة ISO 20022: تحليل الفجوات مقابل متطلبات رسائل MX',
  fx_li_iso_2:'إكمال حقول البيانات المنظمة: مراجعة امتثال المعرّف القانوني للكيان ورمز الغرض وهيكل العنوان',
  fx_li_iso_3:'معايرة فحص العقوبات لبيانات ISO 20022 المنظمة: خفض معدلات الإيجابية الكاذبة مع الحفاظ على التغطية',
  fx_li_iso_4:'تقييم وتحسين الاتصال بـGPI: تكامل التتبع وإعداد تقارير شفافية الرسوم وإدارة اتفاقيات مستوى الخدمة',
  fx_discuss_swift:'ناقش SWIFT GPI / ISO 20022 →',
  fx_h2_multicurr:'استراتيجية التسوية متعددة العملات',
  fx_p_multicurr1:'لمؤسسات الدفع وشركات التكنولوجيا المالية التي تقدم خدمات دفع متعدد العملات، تُحدد بنية التسوية الاقتصاديات التجارية ومخاطر التشغيل. القرارات الرئيسية هي: أزواج العملات التي يتم دعمها أصليًا مقابل التحويل عبر عملة جسر، والنموذج المالكي أم الوكالي، وكيفية إدارة تعرض العملة بين تأمين السعر وإتمام التسوية.',
  fx_h3_fxrisk:'إدارة مخاطر العملات الأجنبية لشركات الدفع',
  fx_p_fxrisk1:'شركة الدفع التي تعرض سعر تحويل للعميل عند التفعيل وتُسوّي بالعملة المقصودة في وقت لاحق تتحمل مخاطر العملة في الفترة الفاصلة. للتحويلات الاستهلاكية صغيرة القيمة، تكون المخاطرة على كل معاملة فردية بالغة الصغر، غير أن إجمالي تعرض المحفظة عبر المعاملات المتزامنة قد يكون كبيرًا خلال فترات تقلب العملة.',
  fx_li_fx_1:'قياس تعرض مخاطر العملات الأجنبية: تحليل القيمة المعرضة للخطر على مستوى المحفظة حسب زوج العملات وفجوة التسوية',
  fx_li_fx_2:'تصميم استراتيجية التحوط: العقود الآجلة والخيارات والتحوط الطبيعي من خلال مطابقة العملات',
  fx_li_fx_3:'اختيار الطرف المقابل في الخزينة: مكاتب العملات الأجنبية البنكية مقابل مزودي العملات المتخصصين لتنفيذ عمليات الصرفالأجنبي',
  fx_li_fx_4:'البنية التحتية للحسابات متعددة العملات: التجميع وهياكل الحسابات الافتراضية وإدارة حسابات النوسترو',
  fx_h3_gcc_fx:'اعتبارات خاصة بالعملات الأجنبية في دول الخليج',
  fx_p_gcc_fx1:'تحافظ عملات دول مجلس التعاون الخليجي الست على ربطها بالدولار الأمريكي، مما يُلغي مخاطر العملة البينية للأزواج المرتبطة، لكنه يُفرز اعتمادات محددة. ثبت سعر الريال السعودي عند 3.75 ريال/دولار منذ 1986، والريال القطري عند 3.64 منذ 1980، والدرهم الإماراتي عند 3.67 منذ 1980. شركات الدفع العاملة في المنطقة بحاجة إلى إدارة متطلبات السيولة بالدولار وقيود التحويل واقتصاديات التحويل للدفع إلى وجهات غير مرتبطة.',
  fx_p_gcc_fx2:'منصة mBridge ومستقبل البنية التحتية للتسوية: منصة mBridge متعددة الأطراف للعملة الرقمية للبنوك المركزية التي طورّرتها مصارف الإمارات والسعودية وبنك الشعب الصيني وبنك تايلاند. أثرها التجاري على اقتصاديات مدفوعات دول الخليج متوسط الأمد، لكن ينبغي لمؤسسات الدفع ذات التعرض الكبير لممر الخليج-آسيا متابعة تطوراتها ودراسة تداعياتها.',
  fx_discuss_fx:'ناقش استراتيجية العملات الأجنبية →',
  fx_h2_treasury:'مدفوعات الخزينة للشركات',
  fx_p_treasury1:'تُجري الشركات الكبرى في دول الخليج — ولا سيما تلك العاملة في قطاعي الطاقة والبناء وجهات القطاع الحكومي — تدفقات مدفوعات عابرة للحدود كبيرة للمشتريات وتمويل المشاريع والرواتب. البنية التحتية للمدفوعات غالبًا ما تكون مجزّأة بعلاقات مصرفية متعددة وصيغ تعليمات دفع غير متسقة ومحدودية الرؤية لحالة الدفعات.',
  fx_p_treasury2:'يعالج تحسين مدفوعات الخزينة هذا التجزّؤ بترشيد اللجنة المصرفية وتوحيد صيغ تعليمات الدفع وتطبيق هياكل بيانات ISO 20022 لتمكين التسوية الآلية وإنشاء هياكل مصنع المدفوعات التي تُمركز تنفيذ المدفوعات مع الحفاظ على الامتثال المحلي ومتطلبات الإبلاغ التنظيمي.',
  fx_h3_factory:'مصنع المدفوعات والبنك الداخلي',
  fx_p_factory1:'يُوجّه هيكل مصنع المدفوعات جميع تعليمات المدفوعات العابرة للحدود عبر كيان مركزي واحد يمتلك العلاقات المصرفية الخارجية وينفذ المدفوعات نيابةً عن الشركات التابعة. الفوائد: تحسين الموضع التفاوضي مع الأطراف المصرفية، وخفض الرسوم، وتحسين اقتصاديات تحويل العملة، ونقطة تحكم واحدة لفحص العقوبات والامتثال.',
  fx_li_treas_1:'تقييم جدوى مصنع المدفوعات: تحليل الأحجام وهيكل الكيان القانوني والمتطلبات التشريعية في كل سوق خليجي',
  fx_li_treas_2:'تصميم هيكل البنك الداخلي: إطار الإقراض بين الشركات والتجميع الوهمي ومقاصة العملات المتقاطعة',
  fx_li_treas_3:'ترشيد اللجنة المصرفية: تصميم طلب تقديم العروض واختيار البنوك المرتبطة وتحسين هيكل الحسابات',
  fx_li_treas_4:'تكامل أنظمة تخطيط موارد المؤسسات: تهيئة وحدة الدفع في SAP وOracle وMicrosoft Dynamics لإخراج ISO 20022',
  fx_li_treas_5:'تكامل فحص العقوبات: فحص قوائم OFAC والأمم المتحدة والاتحاد الأوروبي والجهات التنظيمية الخليجية في سير عمل تفعيل الدفع',
  fx_discuss_treas:'ناقش مدفوعات الخزينة →',
  fx_discuss_gcc:'ناقش متطلباتك →',
  fx_h3_cta:'ناقش متطلبات مدفوعات العملات والخزينة',
  fx_p_cta:'تقدّم MENA Advisory خدمات استشارية للبنوك ومؤسسات الدفع وإدارات خزينة الشركات في مجال البنية التحتية للمدفوعات وإدارة مخاطر العملات وهجرة ISO 20022 وتحسين مدفوعات الخزينة عبر أسواق الخليج وأوروبا. تحدّث مع متخصص لمناقشة وضعك المحدد.'
  };
  const enCache = {};
